function [ data ] = RA_rejectBadIntervalArtifacts( data )
% RA_REJECTBADINTERVALARTIFACTS reject all trials which contains bad
% interval markers
%
% Use as
%   [ data ] = RA_rejectBadIntervalArtifacts( data )
%
% where the input data has to be either a result of RA_IMPORTDATASET
%
