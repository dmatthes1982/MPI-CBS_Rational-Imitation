function [ data ] = RA_pow( data )
% RA_POW estimates the power for all trials of the dataset and averages the
% results over all existing trials.
%
% Use as 
%   [ data ] = RA_pow( data )
%
% where the input data has to be either the result of RA_PRUNESEGMENTS or 
% RA_SEGMENTATION.
%
