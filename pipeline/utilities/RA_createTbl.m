function RA_createTbl( cfg )
% RA_CREATETBL generates '*.xls' files for the documentation of the data 
% processing process.
%
% Use as
%   RA_createTbl( cfg )
...
%   cfg.desFolder   = destination folder (default: '/data/pt_01778/eegData/EEG_RA_processedFT/00_settings/')
...
desFolder   = ft_getopt(cfg, 'desFolder', ...
                '/data/pt_01778/eegData/EEG_RA_processedFT/00_settings/');
...
switch type
  case 'numoftrials'
    ...
    T.Properties.VariableNames = ...
        {'participant', 'SegHandNoT', 'SegHeadNoT', 'SegHandBad', ...
           'SegHeadBad', 'SegHandNogT', 'SegHeadNogT'};
