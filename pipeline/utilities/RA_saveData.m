function RA_saveData( cfg, varargin )
% RA_SAVEDATA stores the data of various structure elements into a
% MAT_File.
%
% Use as
%   RA_saveData( cfg, varargin )
%
% The configuration options are
%   cfg.desFolder   = destination folder (default: '/data/pt_01778/eegData/EEG_RA_processedFT/01a_import/')
...
% Get config options
% -------------------------------------------------------------------------
desFolder   = ft_getopt(cfg, 'desFolder', '/data/pt_01778/eegData/EEG_RA_processedFT/01a_import/');
