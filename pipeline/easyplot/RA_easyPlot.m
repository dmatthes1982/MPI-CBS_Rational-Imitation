function RA_easyPlot( cfg, data )
% RA_EASYPLOT is a function, which makes it easier to plot the data of a 
% specific trial.
%
% Use as
%   RA_easyPlot(cfg, data)
%
% where the input data can be the results of RA_IMPORTDATASET,
...
% RA_REJECTBADINTERVALARTIFACTS, PLOT
